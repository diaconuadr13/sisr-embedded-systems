/*
 * SISR TFLite Micro inference test for ESP32 - ESPCN_Full int8.
 *
 * Test shape:
...
constexpr int kMaxTensorArenaSize = 104 * 1024;
...
static uint8_t* allocate_tensor_arena(size_t* allocated_size) {
    const size_t candidate_sizes[] = {
        104 * 1024, 96 * 1024, 88 * 1024, 80 * 1024, 72 * 1024, 64 * 1024,
    };
...
void setup() {
    Serial.begin(115200);
    delay(1000);
    Serial.println("\n=== SISR TFLite Micro Test (ESPCN_Full int8) ===");
