 ...
 * Model: SRCNN int8 with float32 input/output.
 *
 * SRCNN has bicubic upsampling stripped from the exported model, so
 * test_image.h contains a bicubic pre-upsampled input.
 *
 * Arduino setup:
 ...
 *
 * Or copy the matching generated headers from esp32_firmware/srcnn_inference_int8/.
 */
...
void setup() {
    ...
    Serial.println();
    Serial.println("=== SISR TFLite Micro Test (Pico, SRCNN int8) ===");
